...
from widgets.pyqt.pyqt_slideshow.widgets.aniButton import AniRadioButton
from widgets.pyqt.pyqt_slideshow.widgets.graphicsView import SingleImageGraphicsView
from widgets.pyqt.pyqt_slideshow.widgets.svgButton import QPushButton
...
class SlideShow(QWidget):
    ...
    def __initUi(self):
        ...
        self.__prevBtn = QPushButton(self)
        self.__prevBtn.setIcon(getIconPath('right.svg'))
        self.__prevBtn.setFixedSize(30, 50)
        self.__prevBtn.clicked.connect(self.__prev)
        self.__prevBtn.setEnabled(False)

        self.__nextBtn = QPushButton(self)
        self.__nextBtn.setIcon(getIconPath('left.svg'))
